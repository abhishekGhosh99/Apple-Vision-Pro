...
tl4.to("#page7-upper>h3,#page7-upper>h1", {
  top: `-20%`,
});
...
tl5.to("#page9-upper>h3,#page9-upper>h1", {
  top: `-20%`,
});
...
tl6.to("#page22-upper>h3,#page22-upper>h1", {
  top: `-20%`,
});

const wrapper = document.querySelector("#page25");
const carousel = document.querySelector("#carousel");
const firstCardWidth = carousel.querySelector("#card").offsetWidth;
const arrowBtns = document.querySelectorAll("#page25 i");
...
function canvas1() {
  const canvas = document.querySelector("#page29>canvas");
  const context = canvas.getContext("2d");
...
tl8.to("#page33>#sensor-1", {
  opacity: 0,
});
tl8.to("#page33>#sensor-2", {
  opacity: 0,
});
tl8.to("#page33>#sensor-3", {
  opacity: 0,
});
tl8.to("#page33>#sensor-4", {
  opacity: 0,
});
